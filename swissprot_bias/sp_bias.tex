...
sequence data. However, with the advent of various high-throughput experimental
assays, there are a few papers that dominate the protein annotation
field. Here we investigate just how prevalent is the ``few papers --
...
quality assurance phase. If the source is a research article, the
...
One reflection on annotation coverage is the number of GO terms assigned to
any given protein. Ostensibly, the larger the number of GO terms that are assigned to a
protein, the more comprehensive its annotation, provided that these terms are non-redundant, i.e.
not direct parents of each other. 
...
from the other high throughput studies. 
